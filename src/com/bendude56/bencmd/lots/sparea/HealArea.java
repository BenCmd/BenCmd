...
public class HealArea extends TimedArea {
	...
	public HealArea(String key, String value) throws NumberFormatException, NullPointerException, IndexOutOfBoundsException {
		super(key, value);
	}

	public HealArea(Integer id, Location corner1, Location corner2, Integer minimumTime) {
