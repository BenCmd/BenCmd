	...
	public static List<BCommand> Commands() {
		return Arrays.asList(
				...
				new BCommand("warp",
						...
						"/warp <warp>,/warp lot <Lot ID>;/warp <warp> <player>",
						"bencmd.warp.self;bencmd.warp.other",
						"Teleports the player to a pre-set warp. Replace \"<warp>\" with the actual name of the warp. Use /warp lot <lot ID> to warp to Corner 1 of the specified lot. Be sure to /god yourself!;Teleports another player to a preset warp. Replace \"<player\" with the actual name of the player ot be teleported."),
