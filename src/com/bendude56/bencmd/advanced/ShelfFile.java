...
public class ShelfFile extends BenCmdFile {
	...
	public void saveAll() {
		for (Map.Entry<Location, Shelf> e : shelves.entrySet()) {
			...
			Shelf s = e.getValue();
			getFile().put(loc.getWorld().getName() + "," + loc.getBlockX() + "," + loc.getBlockY() + "," + loc.getBlockZ(), s.getText());
		}
		saveFile();
	}
	...
	public void addShelf(Shelf shelf) {
		...
		getFile().put(loc.getWorld().getName() + "," + loc.getBlockX() + "," + loc.getBlockY() + "," + loc.getBlockZ(), shelf.getText());
		saveFile();
	}
